...
-- Create function to get user conversations with secure search path
...
BEGIN
  ...
  JOIN public.profiles buyer_profile ON c.buyer_id = buyer_profile.id
  JOIN public.profiles seller_profile ON c.seller_id = seller_profile.id
  WHERE c.buyer_id = user_uuid OR c.seller_id = user_uuid
  ORDER BY c.updated_at DESC;
END;
$$;

-- Create function to get conversation details with secure search path
...
-- Create function to get conversation messages with secure search path
...
-- Create function to send a message with secure search path
...
-- Create function to create or get conversation with secure search path
